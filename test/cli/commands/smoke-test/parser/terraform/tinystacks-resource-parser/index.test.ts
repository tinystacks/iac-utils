...
jest.mock('../../../../../../../src/cli/commands/smoke-test/parser/terraform/tinystacks-resource-parser/hashicorp-aws', () => ({
...
const mockTfFile = fs.realRFS(path.realResolve(__dirname, '../../../test-data/vpc-stack/tf/with-nat/main.tf'));
