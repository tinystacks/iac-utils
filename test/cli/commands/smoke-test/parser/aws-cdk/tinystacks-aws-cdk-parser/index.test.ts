...
jest.mock('../../../../../../../src/cli/commands/smoke-test/parser/aws-cdk/tinystacks-aws-cdk-parser/ec2', () => ({
  parseEip: mockParseEip
}));
jest.mock('../../../../../../../src/cli/commands/smoke-test/parser/aws-cdk/tinystacks-aws-cdk-parser/s3', () => ({
  parseS3Bucket: mockParseS3Bucket
}));
jest.mock('../../../../../../../src/cli/commands/smoke-test/parser/aws-cdk/tinystacks-aws-cdk-parser/sqs', () => ({
  parseSqsQueue: mockParseSqsQueue
}));
jest.mock('../../../../../../../src/cli/commands/smoke-test/parser/aws-cdk/tinystacks-aws-cdk-parser/vpc', () => ({
