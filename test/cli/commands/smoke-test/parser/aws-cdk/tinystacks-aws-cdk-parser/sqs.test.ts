import { parseSqsQueue } from "../../../../../../../src/cli/commands/smoke-test/parser/aws-cdk/tinystacks-aws-cdk-parser/sqs";
import { CloudformationTypes } from "../../../../../../../src/cli/commands/smoke-test/smoke-tests/aws/resources";
import { CDK_DIFF_CREATE_SYMBOL } from "../../../../../../../src/cli/constants";
